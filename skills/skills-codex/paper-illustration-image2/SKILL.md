...
- **IMAGE2_HELPER** — canonical name `paper_illustration_image2.py`, resolved
  ...
  [ -z "$IMAGE2_HELPER" ] && {
    ...
    echo "       /paper-illustration-image2 cannot proceed. Fix: rerun the ARIS installer or provide the canonical script through \$ARIS_REPO/skills/paper-illustration-image2/scripts/." >&2
    exit 1
  }
  ```
