...
description: "Autonomous multi-round research review loop using MiniMax API. Use when you want to use MiniMax instead of the default same-family subagent for external review. Trigger with \"auto review loop minimax\" or \"minimax review\"."
---
...
**API Key**: Read from `~/.kimi-code/settings.json` under `env.MINIMAX_API_KEY`, or from environment variable.
