...
[ -n "${ARIS_REPO:-}" ] || { echo "ERROR: ARIS_REPO not set. Use install_aris_kimi.sh managed install or export ARIS_REPO=/path/to/ARIS."; exit 1; }
...
Identified via 2026-04-16 post-mortem analysis (Kimi Code host-strongest subagent) of a 1.5-day
