...
Kimi Code MUST verify the generated Mermaid code by running the Mermaid CLI (`mmdc`).
...
After successful rendering, Kimi Code MUST read the generated PNG and perform a strict review:

```markdown
## Kimi Code's STRICT Review of <diagram-name>
