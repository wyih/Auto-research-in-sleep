...
[ -f "$OPENALEX_FETCHER" ] || {
  echo "ERROR: openalex_fetch.py not resolved at \$ARIS_REPO/tools/, tools/, or ~/.kimi-code/skills/openalex/." >&2
  echo "       Fix: rerun install_aris_kimi.sh, export ARIS_REPO, or copy the helper to ~/.kimi-code/skills/openalex/." >&2
