...
description: "Use when main results pass result-to-claim (`claim_supported = yes` or `partial`) and ablation studies are needed for paper submission. A secondary Kimi Code subagent designs ablations from a reviewer's perspective; the local executor reviews feasibility and implements."
...
### Step 2: Kimi Code Designs Ablations
