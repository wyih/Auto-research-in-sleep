...
- `REVIEWER_MODEL = the host reviewer model` — Fresh Kimi Code examiner; same-family provisional in the base package
...
[summary of the host reviewer model examiner feedback]
...
- If reviewer delegation is unavailable in the current Kimi Code host, stop and ask the user to enable Kimi Code subagent support before continuing.
