...
This runs 2 rounds of examiner-style review via host-strongest subagent. The examiner evaluates clarity, written description, enablement, novelty, non-obviousness, and claim scope.
...
- If a downstream reviewer step is requested but reviewer delegation is unavailable in the current Kimi Code host, stop and ask the user to enable Kimi Code subagent support before continuing.
