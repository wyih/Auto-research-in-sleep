---
name: training-check
description: "Interactively monitor training metrics from the current Kimi Code session, periodically checking WandB or fallback logs for NaN, divergence, plateaus, and broken runs."
