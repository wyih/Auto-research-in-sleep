...
When the user selects an idea, maintain `BUSINESS_RUN_PASSPORT.md` through `business-run-passport` if the project already uses it, the user requests it, or an actual downstream consumer requires it.
